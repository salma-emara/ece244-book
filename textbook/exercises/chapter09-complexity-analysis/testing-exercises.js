  ...
  "exercises": [
    {
      ...
      "type": "explaination",
      "multipart": true,
      "LLM": "Specify the worst case complexity using the Big-O notation. \n\n```{code-block} cpp\nfor (int i = 0; i < n; i++) {\n  for (int j = 0; j * j < n; j++) {\n    // some code with o(1)\n  }\n}\n```\n",
    ...
    },
    {
      ...
      "multipart": true,
      "LLM": "Two students were asked to write a recursive function that given a positive integer `n`, computes $2^n$. Amy wrote the following function:\n\n```{code-block} cpp\nint Amy(int n) {\n  if (n == 0) {\n    return 1;\n  } else {\n    return Amy(n - 1) + Amy(n - 1);\n  }\n}\n```\n\nJohn wrote the following function:\n\n```{code-block} cpp\nint John(int n) {\n  if (n == 0) {\n    return 1;\n  } else {\n    return (2 * John(n - 1));\n  }\n}\n```\n(1) Is Amy's function correct (does it compute and return $2^n$)?\n",

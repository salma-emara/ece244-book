let parsedObject; 
  ...
  "exercises": [
    ...
    },
    {
      ...
      "explanations": [
        "14, The last loop when `five` is entered, `num` is unchanged and 4 will be added to `sum` again. However, in some compilers, `sum` may be printed to be 10, as the complier will set `num` to 0 when `cin.fail()` is raised. This means, **2. 10** is considered correct too."
      ]
    },
    {
      "title": "Question 6 in Fall 2019 Midterm Exam",
